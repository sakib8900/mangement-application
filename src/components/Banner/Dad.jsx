    ...
    <div className="flex flex-col lg:flex-row mb-3 items-center justify-between p-4 space-y-4 lg:space-y-0 lg:space-x-8">
      ...
      <div className="flex-1 text-center lg:text-left px-4">
        ...
        <p className="text-xl text-gray-500 mb-4">
          ...
          system for seamless integration. The changes take place in real-time,
          so you can focus on what really matters.
        </p>
        <p className="text-lg text-gray-500">
          Our intuitive system allows for a smooth user experience, letting you
          make quick adjustments with minimal effort. Get started now and see the
          difference!
        </p>
      </div>
    </div>
